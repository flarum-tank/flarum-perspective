...
export default class PerspectiveSettingsModal extends SettingsModal {
  title() {
    return app.translator.trans('tank-perspective.admin.settings.title');
  }
    ...
    return [
      ...
      m('.Form-group', [
        m('label', Switch.component({
          ...
          children: app.translator.trans('tank-perspective.admin.settings.usemax'),
        })),
      ]),
      m('.Form-group', [
        m('label', Switch.component({
          ...
          children: app.translator.trans('tank-perspective.admin.settings.useexperimental'),
        })),
      ]),
      m('.Form-group', [
        m('label', Switch.component({
          ...
          children: app.translator.trans('tank-perspective.admin.settings.field.toxicity'),
        })),
      ]),
      m('.Form-group', [
        m('label', Switch.component({
          ...
          children: app.translator.trans('tank-perspective.admin.settings.field.threat'),
        })),
      ]),
      m('.Form-group', [
        m('label', Switch.component({
          ...
          children: app.translator.trans('tank-perspective.admin.settings.field.profanity'),
        })),
      ]),
      m('.Form-group', [
        m('label', Switch.component({
          ...
          children: app.translator.trans('tank-perspective.admin.settings.field.sexually_explicit'),
        })),
      ]),
      m('.Form-group', [
        m('label', Switch.component({
          ...
          children: app.translator.trans('tank-perspective.admin.settings.field.flirtation'),
        })),
      ]),
      m('.Form-group', [
        m('label', Switch.component({
          ...
          children: app.translator.trans('tank-perspective.admin.settings.donotstore'),
        })),
      ]),
    ]
  }
